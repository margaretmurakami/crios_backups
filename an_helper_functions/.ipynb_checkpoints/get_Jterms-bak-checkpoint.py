...
def get_Jterms(fnames,tsstr,datetimes,dt,t2,mymsk,iB,RAC,RAC3,myparms):
    ...
    # to do the water mass masking we have to be doing mymsk at each timestep
    ...
    #mymsk = (THETA < 0) & (SALT >= 34) & (SALT <= 34.7)
    #mymsk = (THETA > 2) & (SALT >= 34.5)
