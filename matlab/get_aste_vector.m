...
%atn 18.jan.2022: fix negative indices when llc30 is used:
  if(iface(1)<0);ishift=1-iface(1);iface(1)=iface(1)+ishift;iaste(1)=iaste(1)+ishift;end;
  if(jface(1)<0);jshift=1-jface(1);jface(1)=jface(1)+jshift;jaste(1)=jaste(1)+jshift;end;
%keyboard
