...
% history of amplification studies: Manabe and Stouffer, Serreze, Pithan, Marshall, Huang, Rantanen; 
\cite{Manabe1980,Serreze2009,Screen2010,Pithan2014,Marshall2014,Huang2017,Rantanen2022}

% general observed warming
\cite{Cosimo2014}

% borealizatio/ecosystem impacts:
\cite{Bogstad2015,Dalpadado2014,Fossheim2015}

% sea ice decline (see other Dylan Oldenburg papers):
Ocean impact on sea ice: \cite{Carmack2015}
sea ice minima impact on atmosphere: \cite{Honda2009}
Sea ice decline generally: \cite{Onarheim2018}
...
% papers on the barents sea generally:
\cite{Loeng1991,Lind2012,Smedsrud2013,Arthun2012,Lind2016,Onarheim2017}
...
% FIGURE 4: for the 5 years, for one month; motivate this with figure 2
% goal of this is to show that less sea ice means less stratification

\section{Results}

% FIGURE 5: highlight the convergence anomalies for the five years; side by side with the vertical stratification figure for this region
