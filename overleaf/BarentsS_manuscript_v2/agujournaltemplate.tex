...
The Barents Sea is shaped by two primary water masses: AW and Arctic Water (ArW), defined by their temperature (\emph{T}) and salinity (\emph{S}). Relatively warm and saline, AW enters through the Barents Sea Opening (BSO), cooling and freshening as it flows northward before exiting towards the Arctic Ocean at depth \cite{Loeng1991,Smedsrud2010}. In the North, colder and fresher ArW circulates southward and westward. These two water masses define the stratification of the Barents Sea: the southern part, strongly influences by AW inflow \cite{Hakkinen2009}, and the northern part, marked by seasonal ice coverage and colder, more Arctic conditions \cite{kolas2024}. Following the alpha/beta ocean concept \cite{Nansen1902,Carmack2007,Stewart2016}, the southern Barents Sea resembles a temperature-stratified Atlantic-like structure, while the northern Barents Sea is characterized has salinity-dominated stratification, more similar to the Arctic and sustained largely by ice melt. In the south, as AW progresses northward, it is prevented from surfacing by a fresh, near-surface ArW layer. The boundary between these regimes is the Polar Front (PF), an oceanic feature marked by strong lateral gradients in temperature and salinity. In the western Barents Sea, the PF is steered by bathymetry, whereas in the East, the front broadens and splits into distinct temperature and salinity fronts \cite{Oziel2016}. The dynamics of the PF are important to Atlantification as they defines where AW can lose heat to surface fluxes before it is subducted beneath ArW and enters the Arctic basin. Several factors, including sea ice extent, internal tides, and mesoscale dynamics, influence the PF's location and strength \cite{Parsons1996,Munk1998,Garrett2003,Vage2014,kolas2024}. In recent years, increasing heat content from Atlantification is increasing the temperature gradient across the front, limiting sea ice extent \cite{Barton18}. With Atlantification, increasingly warm and salty water \cite{Oziel2016} is spreading further north \cite{Arthun2012}, threatening local ecologies \cite{Bogstad2015,Dalpadado2014,Ingvaldsen2021} and weakening the stratification of the sea itself \cite{Lind2018}. Given that AW holds enough heat to melt Arctic sea ice were it to surface and has broader implications for the Arctic Ocean warming, understanding the mechanisms by which it interacts with ArW and how this alters the stratification is essential \cite{Polyakov2017,Stroeve2018,Skagseth2020,Grabon2021}. Because the PF defines the northern extent where AW can lose heat to the surface before it is subducted beneath Arctic Water and enters the Arctic basin, its strength and location are key indicators of AW progression \cite{Loeng1991}. Thus, the position of the PF can be a pre-conditioner for the heat and salt transported to the central Arctic.
...
% paragraph on the present and future processes that occur in the Barents Sea
While Atlantification can broadly describe the changes in the Barents Sea, this manifests through several more localized phenomena. The physical processes altering \emph{T} and \emph{S} in the ocean can generally be attributed to advection, diffusion, and surface processes, including shortwave radiation and ice formation and melting processes \cite{StoleHansen1991,long2017}. Advection driven by the inflow of AW plays an important role in establishing strong density gradients, which are a prerequisite for baroclinic instability. This instability generates potential energy that fuels mesoscale eddies, which influence the distribution of tracers like heat and salt \cite{Cole2015}. Mesoscale eddies advect Atlantic-sourced heat and salt into regions where these properties are otherwise scarce, strengthening gradients upon which diffusion acts to homogenize ocean properties. In the Barents Sea, these eddies transport AW toward the Arctic. As the composition of inflowing AW changes with climate change, these gradients in \emph{T} and \emph{S} are shifting, impacting the behavior of these eddies. The increased influence of wind stress on an ice-free ocean is also expected to intensify eddy action \cite{Shao2023,li2024eddy} and distribute ArW along isopycnals at the PF \cite{Porter2020}. Recently, Atlantification of the Barents Sea has intensified salt and temperature gradients across the PF, enhancing potential vorticity (PV) gradients and limiting the expansion of sea ice and expanding the area over which AW can lose hear \cite{Oziel2016,Barton18}. These evolving gradients affect the role of eddies in mixing, as PV constraints limit flow across the PF \cite{Barton18}. However, at the PF, mesoscale eddies enable some degree of cross-frontal exchange and have been noted as a potential cause of weakened stratification of the sea \cite{kolas2024}.  

% isopycnal and diapycnal mixing
In many ways, isopycnal and diapycnal mixing, which act along and across neutral density surfaces, respectively, are an expression of the advective and diffusive processes as well as surface forcing. In the Northern Barents Sea, a "beta ocean" structure, where warmer water resides at depth, makes diapycnal mixing an important area of study since it can weaken stratification and promote a more Atlantic-like water column. Where weaker stratification prevails, vertical mixing introduced by mesoscale eddies could allow heat and salt to impact surface conditions, in turn reducing sea ice cover and altering the impact of surface forcing. Vertical mixing has been evaluated in other ocean models like ROMS \cite{Robertson2019}.
